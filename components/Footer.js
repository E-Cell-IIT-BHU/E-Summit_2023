        ...
        <div className='mx-auto max-w-3xl space-y-6'>
          <div className='flex justify-center gap-6'>
            ...
            >
              <InstagramIcon
                fontSize='large'
                className='text-pink-600 hover:text-pink-600/75 cursor-pointer dark:text-gray-300 dark:hover:text-gray-300/75 hover:scale-125 transition ease-in-out'
              />
            </Link>
            ...
            >
              <LinkedInIcon
                className='text-blue-600 hover:text-blue-600/75 cursor-pointer dark:text-gray-300 dark:hover:text-gray-300/75 hover:scale-125 transition ease-in-out'
                fontSize='large'
              />
            </Link>
          ...
          <p className='mx-auto max-w-lg text-xs text-gray-500 dark:text-gray-400'>
            ...
            changemakers to leave behind a legacy!
