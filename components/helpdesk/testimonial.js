  ...
  return (
   <>
    <section className={styles.facilities}>
         <h1>Our Reviews</h1>
         <p className={styles.desc}>Here's what they have to say about their Summit experience.</p>
         <div className={styles.row}>
             <div className={styles.facilities_col}>
             <Image src={"https://crust.winsomethemes.com/original-dark-elementor/wp-content/uploads/sites/70/2021/11/avatar-2.jpg"}    width="70"
        height="70" alt="image" />
...
Marriage comes with a lot of unavoidable expenses in India and spending a big chunk of your savings on furniture and white goods could be a big challenge. RentoMojo not just took away all our worries but in fact went to the extent of spoiling us. Where I could have owned just some bare essentials after making a huge hole in my pocket or paid unnecessary EMIs. </p>
             ...
             <div className={styles.facilities_col}>
             <Image src={"https://crust.winsomethemes.com/original-dark-elementor/wp-content/uploads/sites/70/2021/11/avatar-1.jpg"}    width="70"
        height="70" alt="image" />
                 <h3>Kaushal Tiwari</h3>
                 <p>
Marriage comes with a lot of unavoidable expenses in India and spending a big chunk of your savings on furniture and white goods could be a big challenge. RentoMojo not just took away all our worries but in fact went to the extent of spoiling us. Where I could have owned just some bare essentials after making a huge hole in my pocket or paid unnecessary EMIs. </p>
             ...
             <div className={styles.facilities_col}>
             <Image src={"https://crust.winsomethemes.com/original-dark-elementor/wp-content/uploads/sites/70/2021/11/young-people.jpg"}    width="70"
        height="70" alt="image" />
                <h3>Naveen Kumar</h3>
                <p>
