...
import akj from "../assets/team/akj.jpg";
import prof from "../assets/team/rajnesh_tyagi.png";
import vp from "../assets/team/vp.jpg";
import avp from "../assets/team/amitavp.jpg";
import sr from "../assets/team/sr.jpeg";
import rieu from "../assets/team/rieu.jpeg";
import ev from "../assets/team/ev.jpeg";
import wnb from "../assets/team/wnb.jpg";
import tqb from "../assets/team/tqb.jpeg";
      ...
      <div style={{ backgroundColor: "black", color: "white" }}>
        ...
        >
          ...
          <div className="row">
            ...
            <Accordion className="past-team" style={{backgroundColor:'#181921', color:'white',border:'none'}}>
              <AccordionSummary
                expandIcon={<ExpandMoreIcon />}
                aria-controls="panel1a-content"
                id="panel1a-header"
                style={{backgroundColor:'rgb(188 169 160)'}}>
                <h2
                  style={{
                    fontSize: "1.4rem",
                    textAlign: "center",
